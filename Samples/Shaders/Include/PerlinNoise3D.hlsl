#ifndef PERLIN_NOISE_3D_INCLUDED
#define PERLIN_NOISE_3D_INCLUDED
...
// The main function. The _float suffix is required by Shader Graph.
void PerlinNoise3D_float(float3 P, out float Out)
{
    ...
    // Scale output to remap roughly to a -1 to 1 range, then shift to 0 to 1
    Out = (2.2 * n_xyz) * 0.5 + 0.5; 
}
#endif